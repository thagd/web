	...
	<body>
		...
		<div class="container-page">
			<form action="${pageContext.request.contextPath}/locadoras/listaCidade" method="post">
				<label for="cidade"><fmt:message key="locadora.listaCidade.city" /></label>
				<input type="text" id="cidade" name="cidade" required size="30" maxlength="30"/>
				<input type="submit" value="<fmt:message key="locadora.listaCidade.search" />" />
			</form>
			
			<h1 align="center"><fmt:message key="locadora.listaCidade.rentalList" /></h1>
			<div align="center">
