...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
				...
				.antMatchers("/locadoras", "/clientes", "/locacoes").permitAll()
				.antMatchers("/locadoras/{\\d+}", "/clientes/{\\d+}", "/locacoes/{\\d+}").permitAll() // REST Controllers (GET by id, PUT - Update by id, DELETE by ID)
